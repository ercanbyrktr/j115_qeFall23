...
import day24_scope_And_Arrays.ADoctor;
...
public class C01_Constructors {
    public static void main(String[] args) {
        ...
        When we wan to create an object from a class, the object data type will be the class we created the object
        ...
        3) Cons. will have same name with class
