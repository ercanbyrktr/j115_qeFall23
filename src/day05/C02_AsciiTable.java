...
public class C02_AsciiTable {
    public static void main(String[] args) {
        ...
        //Ask user to provide a word and print next three letters from alphabet after the first letters of the word
        ...
        System.out.println("next three letters : "+(char)(firstLetter+1)+" "+(char)(firstLetter+2)+" "+(char)(firstLetter+3));
